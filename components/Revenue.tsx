      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-4">
            ...
            <h3 className="text-5xl font-serif mb-8 italic">Equitable Asset Classes</h3>
            <p className="text-white/60 mb-8 font-light leading-relaxed">
              Vanguard disrupts the traditional box-office model. We deconstruct the production process into a multi-layered asset class, integrating physical fine art to provide immediate liquidity.
            </p>
            ...
            <div className="aspect-square glass-panel rounded-2xl overflow-hidden mb-8 relative">
              ...
              <div className="absolute bottom-6 left-6">
                 ...
                 <div className="text-sm font-serif italic">Commodification of Truth</div>
              </div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-xl border-l-4 border-white">
              ...
              <p className="text-xs text-white/50 leading-relaxed">
                We maintain a perpetual 10% royalty on all secondary asset cycles, ensuring long-tail yield independent of distribution windows.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white/5">
                  ...
                  <tr>
                    <td colSpan={2} className="py-8 text-[11px] tracking-[0.3em] font-bold text-white/30 uppercase">Total Phase I Seed Valuation</td>
