      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-7">
          ...
          <div className="space-y-8 text-white/70 leading-relaxed font-light text-xl">
            <p>
              UNFORBIDDEN is a conducting of a creative Inquiry into the biological friction between the <span className="text-white font-normal underline decoration-white/20 underline-offset-4">Vanguard Collective</span>—the sterile prison 
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="aspect-square glass-panel rounded-3xl overflow-hidden relative group">
            ...
            <div className="absolute bottom-8 left-8">
               ...
               <div className="text-lg font-serif italic">The Invincible Prison</div>
            </div>
          </div>

          <div className="glass-panel p-8 rounded-2xl">
            <h3 className="text-xs tracking-widest text-white/40 mb-6 font-bold uppercase">The Trilogy Protocol</h3>
            <div className="space-y-8">
              <div className="border-l border-white/10 pl-6 group transition-all hover:border-white">
                <div className="text-white font-bold mb-1">PART I: THE AWAKENING</div>
                <div className="text-sm text-white/50">A visceral confrontation with the legacy of the collective.</div>
              </div>
              <div className="border-l border-white/10 pl-6 group transition-all hover:border-white">
                <div className="text-white/40 font-bold mb-1 group-hover:text-white transition-colors">PART II: THE RESISTANCE</div>
